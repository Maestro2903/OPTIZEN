...
export const PERMISSIONS: Record<UserRole, {
  ...
  optical_plan: PermissionActions
  ...
  super_admin: {
    ...
    optical_plan: { view: true, create: true, print: true, edit: true, delete: true },
  ...
  hospital_admin: {
    ...
    optical_plan: { view: true, create: true, print: true, edit: true, delete: false },
    lens: { view: true, create: true, print: true, edit: true, delete: true },
    complaint: { view: true, create: true, print: true, edit: true, delete: true },
    treatment: { view: true, create: true, print: true, edit: true, delete: true },
    medicine: { view: true, create: true, print: true, edit: true, delete: true },
  ...
  receptionist: {
    ...
    attendance: { view: true, create: true, print: true, edit: true, delete: false },
    optical_plan: { view: true, create: false, print: false, edit: false, delete: false },
  ...
  billing_staff: {
    ...
    attendance: { view: true, create: true, print: true, edit: true, delete: false },
    optical_plan: { view: false, create: false, print: false, edit: false, delete: false },
  ...
  read_only: {
    ...
    optical_plan: { view: true, create: false, print: true, edit: false, delete: false },
